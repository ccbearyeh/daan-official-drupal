...
namespace Drupal\fpdi_print\Renderer;
...
class ViewRenderer extends RendererBase implements TrustedCallbackInterface {
  ...
  public static function createInstance(ContainerInterface $container, EntityTypeInterface $entity_type) {
    return new static(
      ...
      $container->get('fpdi_print.asset_renderer'),
      $container->get('fpdi_print.filename_generator'),
  ...
  protected function renderSingle(EntityInterface $view) {
    ...
    foreach (['header', 'footer', 'empty'] as $area_type) {
      ...
      unset($handlers['area_fpdi_print_views']);
    }
